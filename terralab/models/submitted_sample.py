...
class SubmittedSample(models.Model):
    ...
    # When this sample is modified, pass on the chatter message to the Order object
                ...
                for tracking_value in newargs['tracking_value_ids']:
                    if len(tracking_value) >= 3:
                        ...
                        if 'field_desc' in attrs:
                            attrs['field_desc'] = '%s %s' % (submitted_sample.name, attrs['field_desc'])
